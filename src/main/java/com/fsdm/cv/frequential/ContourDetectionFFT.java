...
public class ContourDetectionFFT {

    public static File applyHighPassFilter(File imageFile, double cutoffFrequency) {
        try {
            ...
            File outputFile = new File("contour_detected_image.png");
    ...
    public static void main(String[] args) {
        ...
        File outputFile = applyHighPassFilter(inputFile, cutoffFrequency);
        if (outputFile != null) {
            System.out.println("Contour detected image saved to " + outputFile.getPath());
        } else {
            System.out.println("Failed to detect contours.");
        }
    }
}